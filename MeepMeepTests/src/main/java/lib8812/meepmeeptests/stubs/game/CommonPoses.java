...
public class CommonPoses {
	...
	public static final Pose2d INITIAL_RED_NEAR_POSE = new Pose2d(-FieldConstants.TILE_LENGTH_IN*2, FieldConstants.TILE_LENGTH_IN*2 + 3.5, Math.toRadians(360 - BASE_DEGREES_FOR_INITIAL_NEAR_POSE));
