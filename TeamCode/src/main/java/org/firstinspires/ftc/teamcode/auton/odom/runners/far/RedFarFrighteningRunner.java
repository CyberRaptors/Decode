...
public class RedFarFrighteningRunner extends ITeleOpRunner {
	...
	protected void customInit() {
		...
		Action pickupFromLoadingZoneAndMoveToShoot = drive.actionBuilder(CommonPoses.RED_FAR_SHOT_POSE)
				...
				.afterTime(0, bot.setTransferPower(0.15))
				.strafeToLinearHeading(
						CommonPoses.RED_FAR_FRIGHTENING_PICKUP_FROM_LOADING_ZONE_POSE.position,
						CommonPoses.RED_FAR_FRIGHTENING_PICKUP_FROM_LOADING_ZONE_POSE.heading
				)
