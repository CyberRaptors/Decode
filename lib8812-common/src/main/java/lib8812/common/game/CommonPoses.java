...
public class CommonPoses {
	...
	final static double BASE_DEGREES_FOR_FAR_SHOT = 210;
	...
	public static final Pose2d BLUE_FAR_SHOT_POSE = new Pose2d(FieldConstants.TILE_LENGTH_IN*2 + 6, -FieldConstants.TILE_LENGTH_IN*0.5, Math.toRadians(BASE_DEGREES_FOR_FAR_SHOT));
